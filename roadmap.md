...
- [ ] 2. 卡片密度與層級：縮小次要資訊、成像數字做主視覺（併 U-5 徽章通膨——狀態類降為文字註記＋補色彩圖例、U-6 面積做卡片右側大數字）
- [ ] 3. 淺色模式支援
...
- [ ] 21. 疊圖增強（併 roadmap 2 視覺）：圖例 hover 高亮對應線框、1.7m 人形比例參照取代抽象格線的一部分（併 U-10：線框加序號標記對應圖例——色弱者無法只靠色相分辨）
